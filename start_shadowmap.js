...
try {
	...
	prop_pm.PerformAction('cel.action.SetMesh',['name','xi_maleChild_a']);
	...
	prop_ment.PerformAction('cel.action.InitCD',['offset',[0, 0.0, 0]],['body',[0.7,0.7,0.7]],['legs',[0.7,0.7,0.7]]);
